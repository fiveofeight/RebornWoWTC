...
//  LANG_BG_EY_START_TWO_MINUTES        = 755, - defined above
    ...
    LANG_REM_TRANSMOGRIFICATIONS_ITEMS  = 11120,
    LANG_ERR_NO_TRANSMOGRIFICATIONS     = 11121,
    LANG_REM_TRANSMOGRIFICATION_ITEM    = 11122,
    LANG_ERR_NO_TRANSMOGRIFICATION      = 11123,
    LANG_ITEM_TRANSMOGRIFIED            = 11124,
    LANG_ERR_NO_ITEM_SUITABLE           = 11125,
    LANG_ERR_NO_ITEM_EXISTS             = 11126,
    LANG_ERR_EQUIP_SLOT_EMPTY           = 11127,

    LANG_SLOT_NAME_HEAD                 = 11128,
    LANG_SLOT_NAME_SHOULDERS            = 11129,
    LANG_SLOT_NAME_BODY                 = 11130,
    LANG_SLOT_NAME_CHEST                = 11131,
    LANG_SLOT_NAME_WAIST                = 11132,
    LANG_SLOT_NAME_LEGS                 = 11133,
    LANG_SLOT_NAME_FEET                 = 11134,
    LANG_SLOT_NAME_WRISTS               = 11135,
    LANG_SLOT_NAME_HANDS                = 11136,
    LANG_SLOT_NAME_BACK                 = 11137,
    LANG_SLOT_NAME_MAINHAND             = 11138,
    LANG_SLOT_NAME_OFFHAND              = 11139,
    LANG_SLOT_NAME_RANGED               = 11140,
    LANG_SLOT_NAME_TABARD               = 11141,

    LANG_OPTION_BACK                    = 11142,
    LANG_OPTION_REMOVE_ALL              = 11143,
    LANG_POPUP_REMOVE_ALL               = 11144,
    LANG_OPTION_UPDATE_MENU             = 11145,
    LANG_OPTION_REMOVE_ONE              = 11146,
    LANG_POPUP_REMOVE_ONE               = 11147,
    LANG_POPUP_TRANSMOGRIFY             = 11148,

    LANG_ERR_NO_TOKEN                   = 11149
